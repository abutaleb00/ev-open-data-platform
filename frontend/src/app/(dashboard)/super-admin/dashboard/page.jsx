            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-black text-slate-900 mt-0.5">£{metrics.totalRevenue.toFixed(2)}</h3>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-black text-slate-900 mt-0.5">{metrics.totalPowerDelivered.toFixed(1)} <span className="text-xs font-bold text-slate-400">kWh</span></h3>
                    </div>
                </div>
                ...
                <div className="flex justify-between items-center border-b border-slate-50 pb-4">
                    ...
                    <div className="flex space-x-1.5 bg-slate-100 p-1 rounded-xl">
                        <button
                            ...
                            className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-all ${activeMetricView === 'revenue' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-900'}`}
                        >
                            Revenue
                        </button>
                        <button
                            onClick={() => setActiveMetricView('kwh')}
                            className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-all ${activeMetricView === 'kwh' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-900'}`}
                        >
                            Energy
                        </button>
                    </div>
                ...
                {chartMetrics.map((point, idx) => {
                    ...
                    return (
                        <div key={idx} className="flex-1 flex flex-col items-center group h-full justify-end">
                            ...
                            <div className="opacity-0 group-hover:opacity-100 mb-2 bg-slate-900 text-white font-bold text-xs px-2.5 py-1 rounded-lg transition-all duration-200 transform translate-y-1 group-hover:translate-y-0 shadow-md">
